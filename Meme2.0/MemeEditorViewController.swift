...
class MemeEditorViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate,UITextFieldDelegate {
    ...
    // share variable used for editing meme
    var index : Int?
    ...
    */
    ...
    /*
     ...
     -Create delegates for UIImage, textfields, and shareMemeButton within navi controller
     -font for textfields
    ...
    override func viewDidLoad() {
        ...
        // MARK: Edit Meme
        // meme reconstucted from share index variable
        if index != nil{
            shareMemeButton.isEnabled = true
            self.topTextField.text = appDelegate.memes[index!].topText
            self.bottomTextField.text = appDelegate.memes[index!].bottomText
            self.imageView.image = appDelegate.memes[index!].originalImage
        }
    }
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        if let pickedImage = info[UIImagePickerController.InfoKey.originalImage] as? UIImage {
            ...
            shareMemeButton.isEnabled = true //enable the share button
        }
    ...
    func save() {
        ...
        // create meme struct
        let meme = MemeInfo(topText: topTextField.text!, bottomText: bottomTextField.text!, originalImage:  imageView.image!, memedImage: MemeImage)
